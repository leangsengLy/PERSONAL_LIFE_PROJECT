...
const ColorSystemStore = createSlice({
    ...
    initialState:{
        colors:[
                ...
                {color:'4B5945',isDark:false},
                {color:'F72C5B',isDark:false},
                {color:'B1F0F7',isDark:false},
                {color:'0A97B0',isDark:false},
                {color:'0A97B0',isDark:false},
                {color:'2A3335',isDark:false},
                {color:'640D5F',isDark:false},
                {color:'1F4529',isDark:false},
                {color:'4335A7',isDark:true},
                ...
                {color:'740938',isDark:true},
                {color:'133E87',isDark:true},
