                ...
                data.map((val)=>{
                  return (
                    ...
                    {/* <Tooltip placement='top' showArrow={true} content={translateBy({en:val.EnglishName,km:val.Name})}>
                     ...
                     <div onClick={OnSelectBranch} className='cursor-pointer opacity-90  transition-all ease-linear px-3 gap-y-3 py-4 rounded-3xl border-slate flex flex-col justify-center items-center'>
                          <div className='w-[56px] h-[56px] rounded-full bg-[#ffffff0a] flex justify-center items-center'>
